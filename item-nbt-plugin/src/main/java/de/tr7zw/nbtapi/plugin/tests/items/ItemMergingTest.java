...
public class ItemMergingTest implements Test {
    ...
    public void test() throws Exception {
        ...
        if (!new NBTItem(item).hasTag("test")) throw new NbtApiException("Couldn't merge custom NBT tag!");
        ...
        nbti.applyNBT(test);
        if (!nbti.hasTag("test")) throw new NbtApiException("Couldn't merge custom NBT tag!");
        ...
        nbti.clearCustomNBT();
        if (nbti.hasTag("remove")) throw new NbtApiException("Couldn't clear custom NBT tags!");
        if (!nbti.hasTag("author")) throw new NbtApiException("Vanilla tag was removed!");
    }
}
