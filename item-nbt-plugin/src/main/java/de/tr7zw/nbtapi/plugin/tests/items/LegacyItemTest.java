...
public class LegacyItemTest implements Test {
    ...
    public void test() throws Exception {
        ItemStack item = NBT.itemStackFromNBT(
                NBT.parseNBT("{id:cobblestone,Count:42,tag:{Enchantments:[{lvl:3,id:unbreaking}]}}"));
        ...
        if (!item.equals(item2)) throw new NbtApiException("Data-fixed 1.12.2 item didn't load correctly! " + item2);
    }
}
