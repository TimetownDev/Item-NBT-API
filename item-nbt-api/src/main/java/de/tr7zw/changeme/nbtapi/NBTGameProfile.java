...
public class NBTGameProfile {
    ...
    public static NBTCompound toNBT(GameProfile profile) {
        ...
        return new NBTContainer(ReflectionMethod.GAMEPROFILE_SERIALIZE.run(
                null, ObjectCreator.NMS_NBTTAGCOMPOUND.getInstance(), profile));
    }
    ...
    public static GameProfile fromNBT(NBTCompound compound) {
        ...
        return (GameProfile) ReflectionMethod.GAMEPROFILE_DESERIALIZE.run(
                null, NBTReflectionUtil.getToCompount(compound.getCompound(), compound));
    }
}
