...
public class MojangToMapping {
    ...
    private static Map<String, String> MC1_18R1 = new HashMap<String, String>() {

        {
            ...
            put(
                    "net.minecraft.nbt.NbtUtils#writeGameProfile(net.minecraft.nbt.CompoundTag,com.mojang.authlib.GameProfile)",
                    "a");
    ...
    private static Map<String, String> MC1_20R4 = new HashMap<String, String>() {

        {
            ...
            put(
                    "net.minecraft.core.component.DataComponentHolder#get(net.minecraft.core.component.DataComponentType)",
                    "a");
            put("net.minecraft.world.item.component.CustomData#copyTag()", "c");
            put(
                    "net.minecraft.world.item.ItemStack#set(net.minecraft.core.component.DataComponentType,java.lang.Object)",
                    "b");
            ...
            put(
                    "net.minecraft.world.item.ItemStack#parseOptional(net.minecraft.core.HolderLookup$Provider,net.minecraft.nbt.CompoundTag)",
                    "a");
            put(
                    "net.minecraft.world.level.block.entity.BlockEntity#saveWithId(net.minecraft.core.HolderLookup$Provider)",
                    "c");
            put(
                    "net.minecraft.world.level.block.entity.BlockEntity#loadWithComponents(net.minecraft.nbt.CompoundTag,net.minecraft.core.HolderLookup$Provider)",
                    "c");
    ...
    private static Map<String, String> MC1_21R5 = new HashMap<String, String>() {

        {
            putAll(MC1_21R3);
            put(
                    "net.minecraft.core.HolderLookup$Provider#createSerializationContext(com.mojang.serialization.DynamicOps)",
                    "a");
            put("net.minecraft.nbt.CompoundTag#getByteArray(java.lang.String)", "j");
            put("net.minecraft.nbt.CompoundTag#getDouble(java.lang.String)", "h");
            ...
            put(
                    "net.minecraft.world.level.block.entity.BlockEntity#saveWithId(net.minecraft.world.level.storage.ValueOutput)",
                    "d");
            put(
                    "net.minecraft.world.level.block.entity.BlockEntity#loadWithComponents(net.minecraft.world.level.storage.ValueInput)",
                    "b");
            put(
                    "net.minecraft.world.level.storage.TagValueInput#create(net.minecraft.util.ProblemReporter,net.minecraft.core.HolderLookup$Provider,net.minecraft.nbt.CompoundTag)",
                    "a");
            put(
                    "net.minecraft.world.level.storage.TagValueOutput#createWithContext(net.minecraft.util.ProblemReporter,net.minecraft.core.HolderLookup$Provider)",
                    "a");
    ...
    public static Map<String, String> getMapping() {
        switch (MinecraftVersion.getVersion()) {
            ...
            default:
                // this should never happen, unless a version is forgotten here(like 1.19R3 which uses the 1.19R2
                // mappings)
